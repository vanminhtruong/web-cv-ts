...
import { u as useAssetPath } from "./ContactView-DPoXMd_P.js";
...
const _hoisted_3 = { class: "space-y-6 flex-grow" };
const _hoisted_4 = ["d"];
const _hoisted_5 = { class: "flex-1" };
const _hoisted_6 = { class: "text-md font-medium text-gray-700 dark:text-gray-300" };
const _hoisted_7 = {
  key: 0,
  class: "text-gray-600 dark:text-gray-400 mt-1"
};
const _hoisted_8 = ["href"];
const _hoisted_9 = { class: "mt-8 pt-6 border-t border-gray-200 dark:border-gray-700" };
const _hoisted_10 = { class: "text-lg font-medium text-gray-900 dark:text-white mb-4" };
const _hoisted_11 = { class: "flex flex-col space-y-3" };
const _hoisted_12 = ["href"];
const _hoisted_13 = { class: "mt-8" };
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_3, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(contactItems), (item) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", {
                class: "h-10 w-10 rounded-lg flex items-center justify-center mr-3 transition-all duration-300 group-hover:scale-110",
              ...
              createBaseVNode("div", _hoisted_5, [
                ...
                !item.url ? (openBlock(), createElementBlock("p", _hoisted_7, toDisplayString(item.value), 1)) : (openBlock(), createElementBlock("a", {
                  ...
                  class: "text-gray-600 dark:text-gray-400 mt-1 hover:underline transition-colors",
                  style: normalizeStyle({ "color": unref(colorStore).currentColor.primary })
        ...
        createBaseVNode("div", _hoisted_9, [
          ...
          createBaseVNode("div", _hoisted_11, [
            createBaseVNode("a", {
              ...
              target: "_blank",
              rel: "noopener noreferrer",
              class: "flex items-center text-gray-600 dark:text-gray-400 hover:underline transition-colors",
              style: normalizeStyle({ "color": unref(colorStore).currentColor.primary })
            }, [
            ...
            createBaseVNode("a", {
              href: "https://github.com/vanminhtruong/library-management",
              target: "_blank",
              rel: "noopener noreferrer",
              class: "flex items-center text-gray-600 dark:text-gray-400 hover:underline transition-colors",
              style: normalizeStyle({ "color": unref(colorStore).currentColor.primary })
        ...
        createBaseVNode("div", _hoisted_13, [
          createBaseVNode("a", {
            ...
            download: "",
            class: "inline-flex items-center px-4 py-2 rounded-lg text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1",
...
//# sourceMappingURL=ContactInfoSection-D9Z851bt.js.map
