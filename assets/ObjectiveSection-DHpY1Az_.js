import { d as defineComponent, J as useI18n, b as createBlock, v as openBlock, w as withCtx, f as createBaseVNode, a as normalizeStyle, u as unref, t as toDisplayString, y as createVNode, c as createElementBlock } from "./vendor-C9uPxl4s.js";
...
const _hoisted_3 = { class: "grid grid-cols-1 md:grid-cols-2 gap-8 xs:gap-6" };
const _hoisted_4 = { class: "flex items-center mb-4" };
const _hoisted_5 = { class: "xs:text-lg text-xl font-semibold text-gray-900 dark:text-white" };
const _hoisted_6 = { class: "ml-12 space-y-2" };
const _hoisted_7 = { class: "flex items-start" };
const _hoisted_8 = { class: "block xs:text-sm text-gray-700 dark:text-gray-300" };
const _hoisted_9 = { class: "flex items-center mb-4" };
const _hoisted_10 = { class: "xs:text-lg text-xl font-semibold text-gray-900 dark:text-white" };
const _hoisted_11 = { class: "ml-12 space-y-2" };
const _hoisted_12 = { class: "flex items-start" };
const _hoisted_13 = { class: "xs:text-sm text-lg text-gray-700 dark:text-gray-300" };
        ...
        default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(LazySection, {
              class: "rounded-xl shadow-lg p-8 xs:p-5 mb-8 transform hover:-translate-y-1 transition-all duration-300 hover:shadow-xl border-r-4 bg-white dark:bg-gray-800",
...
//# sourceMappingURL=ObjectiveSection-DHpY1Az_.js.map
