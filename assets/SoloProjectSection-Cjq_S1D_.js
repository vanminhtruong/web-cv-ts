...
const _hoisted_9 = { class: "bg-gradient-to-br from-white to-purple-50 dark:from-gray-700 dark:to-gray-600 p-5 xs:p-3 rounded-lg shadow-sm border border-purple-100 dark:border-gray-600 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1" };
...
const _hoisted_13 = { class: "bg-gradient-to-br from-white to-purple-50 dark:from-gray-700 dark:to-gray-600 p-5 xs:p-3 rounded-lg shadow-sm border border-purple-100 dark:border-gray-600 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1" };
...
const _hoisted_17 = { class: "bg-gradient-to-br from-white to-purple-50 dark:from-gray-700 dark:to-gray-600 p-5 xs:p-3 rounded-lg shadow-sm border border-purple-100 dark:border-gray-600 transform transition-all duration-300 hover:shadow-md hover:-translate-y-1" };
...
const _hoisted_21 = {
  ...
  class: "flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-600 transition-colors xs:text-xs"
};
const _hoisted_22 = { class: "flex items-center" };
const _hoisted_23 = { class: "flex items-center" };
const _hoisted_24 = { class: "bg-gradient-to-br from-white to-purple-50 dark:from-gray-700 dark:to-gray-600 p-5 xs:p-3 rounded-lg shadow-sm border border-purple-100 dark:border-gray-600" };
...
const _hoisted_30 = { class: "text-gray-700 dark:text-gray-400 xs:text-sm" };
...
const _hoisted_41 = { class: "text-gray-700 dark:text-gray-400 xs:text-sm" };
                ...
                createBaseVNode("div", _hoisted_17, [
                  ...
                  createBaseVNode("div", _hoisted_19, [
                    ...
                    createBaseVNode("div", _hoisted_22, [
                      ...
                      _cache[7] || (_cache[7] = createBaseVNode("span", { class: "text-gray-700 dark:text-gray-300 xs:text-xs" }, "Vue.js, React.js", -1))
                    ]),
                    createBaseVNode("div", _hoisted_23, [
                      ...
                      _cache[8] || (_cache[8] = createBaseVNode("span", { class: "text-gray-700 dark:text-gray-300 xs:text-xs" }, "Laravel", -1))
                    ])
                  ])
                ])
              ]),
...
//# sourceMappingURL=SoloProjectSection-Cjq_S1D_.js.map
