const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ContactFormSection-CnPGfGRI.js","assets/vendor-1p1qY6MK.js","assets/color-2p_dXya-.js","assets/vendor-toast-BV7TAAOY.js","assets/vendor-toast-jG2HNJHr.css","assets/index-BvAhHeoL.js","assets/index-BBPSw9Ad.css","assets/LazySection-qkdaLalD.js","assets/LazySection-BO97IxP6.css"])))=>i.map(i=>d[i]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ContactView",
  setup(__props) {
    const ContactFormSection = defineAsyncComponent(() => __vitePreload(() => import("./ContactFormSection-CnPGfGRI.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
    const LazySection = defineAsyncComponent(() => __vitePreload(() => import("./LazySection-qkdaLalD.js"), true ? __vite__mapDeps([7,1,5,3,4,6,8]) : void 0));
          ...
          createVNode(unref(LazySection), { class: "mb-16" }, {
            default: withCtx(() => [
              ...
              createBaseVNode("div", _hoisted_5, [
                _cache[1] || (_cache[1] = createBaseVNode("h1", { class: "text-green-500" }, "Hello Minh", -1)),
                _cache[2] || (_cache[2] = createBaseVNode("h2", null, "Ngu học", -1)),
...
//# sourceMappingURL=ContactView-BP_0uXZU.js.map
