import { J as useI18n, A as ref, C as onMounted, P as onUnmounted, d as defineComponent, c as createElementBlock, v as openBlock, f as createBaseVNode, u as unref, N as withDirectives, e as createCommentVNode, g as createTextVNode, n as normalizeClass, Q as vShow, a as normalizeStyle, i as withModifiers, B as watch, K as computed, t as toDisplayString, F as Fragment, j as renderList, S as useCssVars, y as createVNode, U as RouterLink, w as withCtx } from "./vendor-C9uPxl4s.js";
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_2$4, [
            unref(currentLocale) === "en" ? (openBlock(), createElementBlock("span", _hoisted_3$4, _cache[7] || (_cache[7] = [
              createBaseVNode("div", { class: "flag-icon flag-us" }, null, -1),
              createTextVNode(" English ")
            ]))) : unref(currentLocale) === "ko" ? (openBlock(), createElementBlock("span", _hoisted_4$3, _cache[8] || (_cache[8] = [
              createBaseVNode("div", { class: "flag-icon flag-kr" }, null, -1),
              createTextVNode(" 한국어 ")
            ]))) : unref(currentLocale) === "vi" ? (openBlock(), createElementBlock("span", _hoisted_5$3, _cache[9] || (_cache[9] = [
              createBaseVNode("div", { class: "flag-icon flag-vn" }, null, -1),
              createTextVNode(" Tiếng Việt ")
            ]))) : unref(currentLocale) === "zh" ? (openBlock(), createElementBlock("span", _hoisted_6$3, _cache[10] || (_cache[10] = [
              createBaseVNode("div", { class: "flag-icon flag-cn" }, null, -1),
              createTextVNode(" 中文 ")
            ]))) : unref(currentLocale) === "es" ? (openBlock(), createElementBlock("span", _hoisted_7$3, _cache[11] || (_cache[11] = [
              createBaseVNode("div", { class: "flag-icon flag-es" }, null, -1),
              createTextVNode(" Español ")
            ]))) : unref(currentLocale) === "fr" ? (openBlock(), createElementBlock("span", _hoisted_8$3, _cache[12] || (_cache[12] = [
              createBaseVNode("div", { class: "flag-icon flag-fr" }, null, -1),
              createTextVNode(" Français ")
          ...
          withDirectives(createBaseVNode("ul", _hoisted_10$1, [
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "en" }, "flag-option"]),
            ...
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "ko" }, "flag-option"]),
              style: normalizeStyle({ "--hover-bg-color": unref(colorStore).currentColor.primary + "33", "--active-bg-color": unref(colorStore).currentColor.primary })
            }, _cache[15] || (_cache[15] = [
              createBaseVNode("div", { class: "flag-icon flag-kr" }, null, -1),
              createTextVNode(" 한국어 ")
            ...
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "vi" }, "flag-option"]),
              style: normalizeStyle({ "--hover-bg-color": unref(colorStore).currentColor.primary + "33", "--active-bg-color": unref(colorStore).currentColor.primary })
            }, _cache[16] || (_cache[16] = [
              createBaseVNode("div", { class: "flag-icon flag-vn" }, null, -1),
              createTextVNode(" Tiếng Việt ")
            ...
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "zh" }, "flag-option"]),
              style: normalizeStyle({ "--hover-bg-color": unref(colorStore).currentColor.primary + "33", "--active-bg-color": unref(colorStore).currentColor.primary })
            }, _cache[17] || (_cache[17] = [
              createBaseVNode("div", { class: "flag-icon flag-cn" }, null, -1),
              createTextVNode(" 中文 ")
            ...
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "es" }, "flag-option"]),
              style: normalizeStyle({ "--hover-bg-color": unref(colorStore).currentColor.primary + "33", "--active-bg-color": unref(colorStore).currentColor.primary })
            }, _cache[18] || (_cache[18] = [
              createBaseVNode("div", { class: "flag-icon flag-es" }, null, -1),
              createTextVNode(" Español ")
            ...
            createBaseVNode("li", {
              ...
              class: normalizeClass([{ "active": unref(currentLocale) === "fr" }, "flag-option"]),
              style: normalizeStyle({ "--hover-bg-color": unref(colorStore).currentColor.primary + "33", "--active-bg-color": unref(colorStore).currentColor.primary })
            }, _cache[19] || (_cache[19] = [
              createBaseVNode("div", { class: "flag-icon flag-fr" }, null, -1),
              createTextVNode(" Français ")
...
const LanguageSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-b4be93b0"]]);
...
const ColorSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2667e150"]]);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d4e65d4"]]);
export {
  Header as default
};
//# sourceMappingURL=Header-DeGXOb3x.js.map
