...
import { d as defineComponent, J as useI18n, b as createBlock, v as openBlock, w as withCtx, f as createBaseVNode, a as normalizeStyle, u as unref, t as toDisplayString, g as createTextVNode } from "./vendor-C9uPxl4s.js";
...
const _hoisted_13 = { class: "xs:text-lg text-xl font-semibold text-gray-900 dark:text-white" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(LazySection, { class: "mb-16 p-4" }, {
        default: withCtx(() => [
          ...
          createBaseVNode("div", {
            class: "bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 xs:p-4 transform hover:-translate-y-1 border-l-4",
              ...
              createBaseVNode("div", null, [
                createBaseVNode("div", _hoisted_4, [
                  createBaseVNode("div", _hoisted_5, [
                    ...
                    createBaseVNode("h3", {
                      class: "xs:text-lg text-xl font-semibold",
                  ...
                  _cache[2] || (_cache[2] = createBaseVNode("div", { class: "flex flex-wrap gap-2 ml-13" }, [
                    createBaseVNode("span", { class: "px-4 py-2 xs:px-3 xs:py-1 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 text-indigo-800 dark:text-indigo-300 rounded-lg text-sm xs:text-xs font-medium border border-indigo-200 shadow-sm hover:shadow transition-all duration-300 hover:-translate-y-1 flex items-center" }, [
                      createBaseVNode("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                ...
                createBaseVNode("div", _hoisted_6, [
                  ...
                  _cache[4] || (_cache[4] = createBaseVNode("div", { class: "flex flex-wrap gap-2 ml-13" }, [
                    createBaseVNode("span", { class: "px-4 py-2 xs:px-3 xs:py-1 bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 text-emerald-800 dark:text-emerald-300 rounded-lg text-sm xs:text-xs font-medium border border-emerald-200 dark:border-emerald-800 shadow-sm hover:shadow transition-all duration-300 hover:-translate-y-1 flex items-center" }, [
                      createBaseVNode("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                ...
                createBaseVNode("div", _hoisted_8, [
                  ...
                  _cache[6] || (_cache[6] = createBaseVNode("div", { class: "flex flex-wrap gap-2 ml-13" }, [
                    createBaseVNode("span", { class: "px-4 py-2 xs:px-3 xs:py-1 bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 text-cyan-800 dark:text-cyan-300 rounded-lg text-sm xs:text-xs font-medium border border-cyan-200 dark:border-cyan-800 shadow-sm hover:shadow transition-all duration-300 hover:-translate-y-1 flex items-center" }, [
                      createBaseVNode("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
              ...
              createBaseVNode("div", null, [
                createBaseVNode("div", _hoisted_10, [
                  ...
                  _cache[8] || (_cache[8] = createBaseVNode("div", { class: "flex flex-wrap gap-2 ml-13" }, [
                    createBaseVNode("span", { class: "px-4 py-2 xs:px-3 xs:py-1 bg-gradient-to-r from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30 text-purple-800 dark:text-purple-300 rounded-lg text-sm xs:text-xs font-medium border border-purple-200 dark:border-purple-800 shadow-sm hover:shadow transition-all duration-300 hover:-translate-y-1 flex items-center" }, [
                      createBaseVNode("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                ...
                createBaseVNode("div", null, [
                  ...
                  _cache[10] || (_cache[10] = createBaseVNode("div", { class: "flex flex-wrap gap-2 ml-13" }, [
                    createBaseVNode("span", { class: "px-4 py-2 xs:px-3 xs:py-1 bg-gradient-to-r from-pink-100 to-rose-100 dark:from-pink-900/30 dark:to-rose-900/30 text-rose-800 dark:text-rose-300 rounded-lg text-sm xs:text-xs font-medium border border-rose-200 dark:border-rose-800 shadow-sm hover:shadow transition-all duration-300 hover:-translate-y-1 flex items-center" }, [
                      createBaseVNode("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
...
//# sourceMappingURL=SkillsSection-DWEKd7AB.js.map
