...
import { d as defineComponent, J as useI18n, b as createBlock, v as openBlock, w as withCtx, f as createBaseVNode, a as normalizeStyle, u as unref, t as toDisplayString, c as createElementBlock } from "./vendor-C9uPxl4s.js";
...
const _hoisted_5 = { class: "text-gray-600 dark:text-gray-400 mt-1 xs:text-sm" };
...
const _hoisted_10 = { class: "xs:text-sm" };
const _hoisted_11 = { class: "flex items-start" };
const _hoisted_12 = { class: "xs:text-sm" };
const _hoisted_13 = { class: "flex items-start" };
const _hoisted_14 = { class: "xs:text-sm" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(LazySection, { class: "mb-16 p-4" }, {
        default: withCtx(() => [
          ...
          createBaseVNode("div", {
            class: "bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 xs:p-4 mb-8 transform hover:-translate-y-1 border-l-4",
            ...
            createBaseVNode("div", _hoisted_3, [
              ...
              createBaseVNode("div", {
                class: "flex items-center font-medium mt-4 md:mt-0 px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-white xs:text-xs",
            ...
            createBaseVNode("div", {
              class: "ml-16 mt-6 bg-white dark:bg-gray-700 p-5 xs:p-3 rounded-lg shadow-sm border dark:border-gray-600",
              ...
              createBaseVNode("ul", _hoisted_8, [
                createBaseVNode("li", _hoisted_9, [
                  ...
                  createBaseVNode("span", _hoisted_10, toDisplayString(unref(t)("skills.course1")), 1)
                ]),
                createBaseVNode("li", _hoisted_11, [
                  ...
                  createBaseVNode("span", _hoisted_12, toDisplayString(unref(t)("skills.course2")), 1)
                ]),
                createBaseVNode("li", _hoisted_13, [
                  ...
                  createBaseVNode("span", _hoisted_14, toDisplayString(unref(t)("skills.course3")), 1)
                ])
              ])
            ], 4)
          ], 4)
...
//# sourceMappingURL=EducationSection-CxoUQHoM.js.map
