import { d as defineComponent, J as useI18n, b as createBlock, v as openBlock, w as withCtx, f as createBaseVNode, a as normalizeStyle, u as unref, t as toDisplayString } from "./vendor-C9uPxl4s.js";
...
const _hoisted_3 = { class: "xs:text-base text-lg text-gray-700 dark:text-gray-300 leading-relaxed" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(LazySection, { class: "mb-16 p-4" }, {
        default: withCtx(() => [
          ...
          createBaseVNode("div", {
            class: "bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 xs:p-5 mb-6 transform hover:-translate-y-1 border-l-4",
...
//# sourceMappingURL=IntroductionSection-DjASPkJz.js.map
